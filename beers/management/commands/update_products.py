    ...
    def handle(self, *args, **options):
        ...
        with httpx.Client() as client:
            ...
            for product_type in product_types:
                page = 0
                while True:
                    HTTP_CODE, products, total_page_count = vmp_api_products.get_products(client, product_type, page)
                    page += 1
            ...
            for product in all_products:
                ...
                if int(product["code"]) in db_products:
                    ...
                    product_details = vmp_api_products.get_product_details(client, product["code"])
