...
def is_restocked(current_stock, new_stock, stock_before_empty):
    ...
    If the restock quantity is less than or equal to the stock prior to stock=0 it is not considered to be a restock. 
...
def get_restock_qty(current_stock, new_stock, stock_before_empty):
    '''
    ...
    if stock_before_empty and new_stock > stock_before_empty:
        _restock_qty = new_stock - stock_before_empty
    else:
